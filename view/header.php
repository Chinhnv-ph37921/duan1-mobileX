            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4">
                    <div class="header-info_area">
                        <span>Chào mừng đến với mobileX!</span>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-6 order-1 order-lg-1 order-sm-1">
                    <div class="hm-logo">
                        <a href="index.php">
                            <img src="./src/image/menu/logo/mobileX-removebg-preview.png" alt="Logo mobileX" />
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-3 col-md-3">
                    <div class="contact-info">
                        <a href="tel://0337686606"><i class="fa fa-phone-volume"></i>+84 337686606</a>
                    </div>
                </div>
