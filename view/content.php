...
<div class="banner-with-content_area @@item-separation">
    ...
    <div class="jb-banner_content">
        ...
        <div class="product-desc" style="margin-top: 5px;">
            <p>
                Mua điện thoại iPhone 14, 14 Plus, 14 Pro, 14 Pro Max tại mobileX. Trả Góp 0%. Thu cũ đổi mới giá tốt. Nhiều ưu đãi khủng. Chần chừ gì nữa mà không nhấc máy đặt hàng ngay?
            </p>
        </div>
...
<!--Banner sale -->
<div class="jb-banner_area banner-two_columns" style="padding-bottom : 30px;">
    <div class="container">
        <div class="row g-0">
            <div class="col-lg-6">
                <div class="banner-item">
